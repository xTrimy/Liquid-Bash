  ...
  void toggleResponse() {
    setState(() {
      if (state) {
        status = "SUCCESS \!";
        message =
            "You have successfully registerd in Gamers Lounge Summer Cup V 'VALORANT' tournament ";
        ...
        status = "OOPS \!";
        message =
            "Unfortunately, you can't register in multiple tournaments at the same time";
